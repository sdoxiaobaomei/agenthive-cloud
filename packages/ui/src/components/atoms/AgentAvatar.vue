...
import type { AgentRole, AgentStatus } from '@agenthive/types'
...
const shibaSrc = computed(() => {
  const map: Record<string, string> = {
    tech_lead: '/avatars/shiba_tl.png',
    frontend_dev: '/avatars/shiba_fe.png',
    backend_dev: '/avatars/shiba_be.png',
    qa_engineer: '/avatars/shiba_qa.png',
  }
