...
│           │   ├── variables.tf
│           │   └── outputs.tf
│           └── github-oidc-role/          #   GitHub Actions OIDC 角色
│               ├── README.md
│               ├── main.tf
│               ├── variables.tf
│               └── outputs.tf
...
| **配置 GitHub OIDC 联邦身份** | `alicloud/terraform/modules/github-oidc-role/` | 零长期密钥的 CI/CD 认证方案 |
...
AgentHive 项目已迁移到 **GitHub OIDC + 阿里云 RAM 角色** 方案，**不再需要 AccessKey**。

在仓库 **Settings → Secrets and variables → Actions** 中添加：

```
ALIYUN_ACCOUNT_ID = 你的阿里云 16 位账号 ID
ALIYUN_ROLE_ARN   = acs:ram::<账号ID>:role/<角色名>
```

完整配置流程见 [`modules/github-oidc-role/README.md`](alicloud/terraform/modules/github-oidc-role/)。

> ✅ **已配置**: 阿里云 OIDC 身份提供商 + RAM 角色 + 最小权限自定义策略
>
> 角色 ARN: `acs:ram::1261729158179509:role/agenthive-cloud-github-actions-role`
