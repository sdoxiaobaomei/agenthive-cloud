  ...
  tickets: [
    {
      ...
      context: {
        relevant_files: [
          ...
          'agenthive-cloud/apps/web/src/components/execution/ExecutionBoard.vue',
        ],
    ...
    },
    {
      ...
      context: {
        relevant_files: [
          ...
          'agenthive-cloud/apps/web/src/stores/execution.ts',
        ],
    ...
    },
    {
      ...
      context: {
        relevant_files: [
          'agenthive-cloud/apps/web/src/views/Workspace.vue',
          'agenthive-cloud/apps/web/src/views/Dashboard.vue',
        ],
