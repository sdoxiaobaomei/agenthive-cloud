...
const migrations = [
  // T024 Dashboard
  {
    src: 'apps/web/src/views/Dashboard.vue',
    dest: 'apps/landing/pages/app/dashboard.vue',
    reps: [
  ...
  {
    src: 'apps/web/src/views/AgentDetail.vue',
    dest: 'apps/landing/pages/app/agents/[id].vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
  ...
  // T026 TaskBoard
  {
    src: 'apps/web/src/views/TaskBoard.vue',
    dest: 'apps/landing/pages/app/tasks.vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
    ]
  },
  // T027 SprintBoard
  {
    src: 'apps/web/src/views/SprintBoard.vue',
    dest: 'apps/landing/pages/app/sprints.vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
    ]
  },
  // T039 Login
  {
    ...
    dest: 'apps/landing/pages/login.vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
    ]
  },
  // T040 Settings
  {
    src: 'apps/web/src/views/Settings.vue',
    dest: 'apps/landing/pages/app/settings.vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
    ]
  },
  // T042 NotFound
  {
    src: 'apps/web/src/views/NotFound.vue',
    dest: 'apps/landing/pages/[...slug].vue',
    reps: [
      [/@\/types/g, '@agenthive/types'],
    ]
  },
...
fs.mkdirSync('apps/landing/pages/app', { recursive: true });
fs.writeFileSync('apps/landing/pages/app/index.vue', `<script setup>
...
fs.mkdirSync('apps/landing/middleware', { recursive: true });
fs.writeFileSync('apps/landing/middleware/auth.global.ts', `export default defineNuxtRouteMiddleware((to) => {
...
copyAndRewrite(
  'apps/web/src/views/CodeViewer.vue',
...
copyAndRewrite(
  'apps/web/src/stores/messageHub.ts',
...
copyAndRewrite(
  'apps/web/src/utils/execution-demo.ts',
...
const agentComps = fs.readdirSync('apps/web/src/components/agent');
for (const f of agentComps) {
  copyAndRewrite(
    `apps/web/src/components/agent/${f}`,
